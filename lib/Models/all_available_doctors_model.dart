class AllAvailableDoctorsModel {
  ...
  factory AllAvailableDoctorsModel.fromJson(Map<String, dynamic> json) {
    return AllAvailableDoctorsModel(
      id: json['id'],
      currentlyLoggedinPartnerId: int.tryParse(json['currently_loggedin_partner_id'].toString()) ?? 0,
      ...
      partnerDoctorPincode: json['partner_doctor_pincode']?.toString() ?? '',
      partnerDoctorGoogleMapLink: json['partner_doctor_google_map_link'] == 'null' ? null : json['partner_doctor_google_map_link'],
      partnerDoctorState: json['partner_doctor_state'] == 'null' ? null : json['partner_doctor_state'],
      partnerDoctorCity: json['partner_doctor_city'] == 'null' ? null : json['partner_doctor_city'],
      partnerDoctorAddress: json['partner_doctor_address'] == 'null' ? null : json['partner_doctor_address'],
      visitDayTime: json['visit_day_time'] is List ? json['visit_day_time'] : [],
      status: json['status'] ?? '',
      createdAt: DateTime.parse(json['created_at']),
      updatedAt: DateTime.parse(json['updated_at']),
      banner: json['banner'] != null
          ? (json['banner']['doctorbanner'] as String).replaceFirst('127.0.0.1', '10.0.2.2')
          : '',
    );
  }

  factory AllAvailableDoctorsModel.fromSearchResult(Map<String, dynamic> json) {
    return AllAvailableDoctorsModel(
      id: json['id'] ?? 0,
      currentlyLoggedinPartnerId: int.tryParse(json['currently_loggedin_partner_id'].toString()) ?? 0,
      clinicRegistrationType: json['clinic_registration_type'] ?? '',
